...
The Latest Debian Package Can Be Downloaded and Installed
  [Documentation]  Test downloading and installing the latest Debian package on Linux arm64 hosts.
  Given The Latest Debian Package Is Downloaded Successfully  linux  arm64
...
The Latest Tar Package Can Be Downloaded and Extracted
  [Documentation]  Test downloading and extracting the latest Tar package on Linux arm64 hosts.
  Given The Latest Tar Package Is Downloaded Successfully  Linux  arm64
  When The Download Package Is Extracted Successfully
  Then The Installation Is Working As Expected
  And The License Terms Should Be Valid
  And The Changelog Should Be Present
...
*** Keywords ***
Install Linux Arm64 Suite Setup
  Common Setup
  Skip If Host Operating System Is Not  Linux
  Skip If Host Architecture Is Not  ${ARCH_AARCH64}
  GitHub Token Is Set
  GitHub Is Reachable

Install Linux Arm64 Suite Teardown
